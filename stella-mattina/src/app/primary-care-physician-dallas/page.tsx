...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/primary-care-physician-dallas' },
  openGraph: {
    title: `${service.title} | Stella Mattina`,
    description: service.meta_description ?? service.full_text.substring(0, 155),
    url: '/primary-care-physician-dallas',
    type: 'website',
  ...
  return (
    <PageWrapper>
      <BreadcrumbJsonLd items={[
        ...
        { name: 'Primary Care Dallas', url: 'https://stellamattina.com/primary-care-physician-dallas' },
      ]} />
      <script
