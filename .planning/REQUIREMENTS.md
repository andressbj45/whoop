...
- [ ] **DESIGN-01**: Ask Tia-inspired global layout applied (clean minimal, warm personal feel, generous whitespace)
- [ ] **DESIGN-02**: Site is fully mobile-responsive across all page types
- [ ] **DESIGN-03**: SM logo displayed in header and footer
- [ ] **DESIGN-04**: "Book Now" CTA button present on every page, linking to patient portal
...
- [ ] **DOC-02**: Individual doctor bio pages with photo, credentials, specialties, and "Book with [Name]" CTA
- [ ] **DOC-03**: Physician schema.org JSON-LD on each doctor bio page
...
| SERV-02 | TBD | Pending |
| SERV-03 | TBD | Pending |
| SEOLP-01 | TBD | Pending |
| SEOLP-02 | TBD | Pending |
| BLOG-01 | TBD | Pending |
| BLOG-02 | TBD | Pending |
| BLOG-03 | TBD | Pending |
| LOC-01 | TBD | Pending |
...
- Mapped to phases: 8 (Foundation + Design System, Phase 1)
- Unmapped: 26 (will be mapped by roadmapper)
